...
function Debug.draw(self)
    ...
    love.graphics.print(string.format("State: %s", G.state.current:tostring()), 10, start_y + line_height * 5)
    love.graphics.print(string.format("Time: %.2f", G.time:get_scale()), 10, start_y + line_height * 6)
